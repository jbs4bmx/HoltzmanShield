...
class Holtzman {
    ...
    setConfigOptions(container) {
        ...
        db.templates.items["55d7217a4bdc2d86028b456d"]._props.Slots[14]._props.filters[0].Filter.push("HShieldEvade", "HShieldTG", "HShieldUSEC", "HShieldYellow", "HShieldUntar", "HShieldRed", "HShieldWhite", "HShieldRivals", "HShieldAlpha", "HShieldRFArmy", "HShieldTrainHard", "HShieldGreen", "HShieldBlue", "HShieldKiba", "HShieldDead", "HShieldLabs", "HShieldBear");
        let armor = [];
        let segments = [];
        ...
        for (var i = 0; i < handBook.length; i++) {
            if (handBook[i].Id == "HShieldEvade") {
                handBook[i].Price = Resources.traderPrice;
            }
            if (handBook[i].Id == "HShieldTG") {
                handBook[i].Price = Resources.traderPrice;
            }
            if (handBook[i].Id == "HShieldUSEC") {
                handBook[i].Price = Resources.traderPrice;
            }
            if (handBook[i].Id == "HShieldYellow") {
                handBook[i].Price = Resources.traderPrice;
            }
            if (handBook[i].Id == "HShieldUntar") {
                handBook[i].Price = Resources.traderPrice;
            }
            if (handBook[i].Id == "HShieldRed") {
                handBook[i].Price = Resources.traderPrice;
            }
            if (handBook[i].Id == "HShieldWhite") {
                handBook[i].Price = Resources.traderPrice;
            }
            if (handBook[i].Id == "HShieldRivals") {
                handBook[i].Price = Resources.traderPrice;
            }
            if (handBook[i].Id == "HShieldAlpha") {
                handBook[i].Price = Resources.traderPrice;
            }
            if (handBook[i].Id == "HShieldRFArmy") {
                handBook[i].Price = Resources.traderPrice;
            }
            if (handBook[i].Id == "HShieldTrainHard") {
                handBook[i].Price = Resources.traderPrice;
            }
            if (handBook[i].Id == "HShieldGreen") {
                handBook[i].Price = Resources.traderPrice;
            }
            if (handBook[i].Id == "HShieldBlue") {
                handBook[i].Price = Resources.traderPrice;
            }
            if (handBook[i].Id == "HShieldKiba") {
                handBook[i].Price = Resources.traderPrice;
            }
            if (handBook[i].Id == "HShieldDead") {
                handBook[i].Price = Resources.traderPrice;
            }
            if (handBook[i].Id == "HShieldLabs") {
                handBook[i].Price = Resources.traderPrice;
            }
            if (handBook[i].Id == "HShieldBear") {
                handBook[i].Price = Resources.traderPrice;
            }
        }
        for (var i = 0; i < priceList.length; i++) {
            if (priceList[i] == "HShieldEvade") {
                priceList[i] = Resources.traderPrice;
            }
            if (priceList[i] == "HShieldTG") {
                priceList[i] = Resources.traderPrice;
            }
            if (priceList[i] == "HShieldUSEC") {
                priceList[i] = Resources.traderPrice;
            }
            if (priceList[i] == "HShieldYellow") {
                priceList[i] = Resources.traderPrice;
            }
            if (priceList[i] == "HShieldUntar") {
                priceList[i] = Resources.traderPrice;
            }
            if (priceList[i] == "HShieldRed") {
                priceList[i] = Resources.traderPrice;
            }
            if (priceList[i] == "HShieldWhite") {
                priceList[i] = Resources.traderPrice;
            }
            if (priceList[i] == "HShieldRivals") {
                priceList[i] = Resources.traderPrice;
            }
            if (priceList[i] == "HShieldAlpha") {
                priceList[i] = Resources.traderPrice;
            }
            if (priceList[i] == "HShieldRFArmy") {
                priceList[i] = Resources.traderPrice;
            }
            if (priceList[i] == "HShieldTrainHard") {
                priceList[i] = Resources.traderPrice;
            }
            if (priceList[i] == "HShieldGreen") {
                priceList[i] = Resources.traderPrice;
            }
            if (priceList[i] == "HShieldBlue") {
                priceList[i] = Resources.traderPrice;
            }
            if (priceList[i] == "HShieldKiba") {
                priceList[i] = Resources.traderPrice;
            }
            if (priceList[i] == "HShieldDead") {
                priceList[i] = Resources.traderPrice;
            }
            if (priceList[i] == "HShieldLabs") {
                priceList[i] = Resources.traderPrice;
            }
            if (priceList[i] == "HShieldBear") {
                priceList[i] = Resources.traderPrice;
            }
        }
        for (const barterItem in barterScheme) {
            if (barterItem == "HShieldEvade") {
                barterScheme[barterItem][0][0].count = Resources.traderPrice;
            }
            if (barterItem == "HShieldTG") {
                barterScheme[barterItem][0][0].count = Resources.traderPrice;
            }
            if (barterItem == "HShieldUSEC") {
                barterScheme[barterItem][0][0].count = Resources.traderPrice;
            }
            if (barterItem == "HShieldYellow") {
                barterScheme[barterItem][0][0].count = Resources.traderPrice;
            }
            if (barterItem == "HShieldUntar") {
                barterScheme[barterItem][0][0].count = Resources.traderPrice;
            }
            if (barterItem == "HShieldRed") {
                barterScheme[barterItem][0][0].count = Resources.traderPrice;
            }
            if (barterItem == "HShieldWhite") {
                barterScheme[barterItem][0][0].count = Resources.traderPrice;
            }
            if (barterItem == "HShieldRivals") {
                barterScheme[barterItem][0][0].count = Resources.traderPrice;
            }
            if (barterItem == "HShieldAlpha") {
                barterScheme[barterItem][0][0].count = Resources.traderPrice;
            }
            if (barterItem == "HShieldRFArmy") {
                barterScheme[barterItem][0][0].count = Resources.traderPrice;
            }
            if (barterItem == "HShieldTrainHard") {
                barterScheme[barterItem][0][0].count = Resources.traderPrice;
            }
            if (barterItem == "HShieldGreen") {
                barterScheme[barterItem][0][0].count = Resources.traderPrice;
            }
            if (barterItem == "HShieldBlue") {
                barterScheme[barterItem][0][0].count = Resources.traderPrice;
            }
            if (barterItem == "HShieldKiba") {
                barterScheme[barterItem][0][0].count = Resources.traderPrice;
            }
            if (barterItem == "HShieldDead") {
                barterScheme[barterItem][0][0].count = Resources.traderPrice;
            }
            if (barterItem == "HShieldLabs") {
                barterScheme[barterItem][0][0].count = Resources.traderPrice;
            }
            if (barterItem == "HShieldBear") {
                barterScheme[barterItem][0][0].count = Resources.traderPrice;
            }
        }
        if (throughput === 0) {
