...
class Holtzman implements IMod
{
    ...
    public setConfigOptions(container: DependencyContainer): void
    {
        ...
        if (typeof GodMode.Enabled === "boolean") { if (GodMode.Enabled) {var througput = 0 } else { var throughput = 1 } }

        db.templates.items["HShieldEvade"]._props.CreditsPrice = Resources.traderPrice;
        ...
        db.templates.items["HShieldTG"]._props.CreditsPrice = Resources.traderPrice;
        ...
        db.templates.items["HShieldUSEC"]._props.CreditsPrice = Resources.traderPrice;
        ...
        db.templates.items["HShieldYellow"]._props.CreditsPrice = Resources.traderPrice;
        ...
        db.templates.items["HShieldUntar"]._props.CreditsPrice = Resources.traderPrice;
        ...
        db.templates.items["HShieldRed"]._props.CreditsPrice = Resources.traderPrice;
        ...
        db.templates.items["HShieldWhite"]._props.CreditsPrice = Resources.traderPrice;
        ...
        db.templates.items["HShieldRivals"]._props.CreditsPrice = Resources.traderPrice;
        ...
        db.templates.items["HShieldAlpha"]._props.CreditsPrice = Resources.traderPrice;
        ...
        db.templates.items["HShieldRFArmy"]._props.CreditsPrice = Resources.traderPrice;
        ...
        db.templates.items["HShieldTrainHard"]._props.CreditsPrice = Resources.traderPrice;
        ...
        db.templates.items["HShieldGreen"]._props.CreditsPrice = Resources.traderPrice;
        ...
        db.templates.items["HShieldBlue"]._props.CreditsPrice = Resources.traderPrice;
        ...
        db.templates.items["HShieldKiba"]._props.CreditsPrice = Resources.traderPrice;
        ...
        db.templates.items["HShieldDead"]._props.CreditsPrice = Resources.traderPrice;
        ...
        db.templates.items["HShieldLabs"]._props.CreditsPrice = Resources.traderPrice;
        ...
        db.templates.items["HShieldBear"]._props.CreditsPrice = Resources.traderPrice;
